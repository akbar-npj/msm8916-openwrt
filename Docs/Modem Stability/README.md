...
132. **⚠ AN AP RESET SURVIVED 823 — 823 IS NOT A COMPLETE FIX (Doc 170 §8.10).** The host-side
...
134. **THE RESET MECHANISM IS NAMED: the PM8916 PON WATCHDOG, ACTIVE, 30 s — AND THE RATE IS NOT RARE
     (Doc 170 §8.11).** The AP does not panic; it **stops**. Read from the device:
