...
128. **ONE BOOT WITH 823 HUNG AT t=73.93 s — CAUSE UNRESOLVED, AND 823 IS *NOT* EXCULPATED (Doc 170
     §8.8).** The boot immediately after the module swap reached 73.93 s and the console **stopped**;
