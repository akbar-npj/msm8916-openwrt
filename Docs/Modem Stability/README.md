...
suppressed on the console at `console_loglevel = 6`; and **patch 821 is written but not yet scored**).
...
122. **820 WORKS — AND IT MOVED THE HANG. `echo stop` IS NOW A 2-SECOND FORCING FUNCTION, AND
     ...
     **What it did not fix: the AP still freezes — after T4.** **The measurement that explains boot
