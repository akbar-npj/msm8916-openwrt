...
public class AdnRecord implements Parcelable {
    ...
    public static final Parcelable.Creator<AdnRecord> CREATOR = new Parcelable.Creator<AdnRecord>() { // from class: com.android.internal.telephony.uicc.AdnRecord.1
        ...
        public AdnRecord createFromParcel(Parcel source) {
            ...
            String[] additionalNumbers = source.readStringArray();
    ...
    public boolean isEqual(AdnRecord adn) {
        return stringCompareNullEqualsEmpty(this.mAlphaTag, adn.mAlphaTag) && stringCompareNullEqualsEmpty(this.mNumber, adn.mNumber) && Arrays.equals(this.mEmails, adn.mEmails) && Arrays.equals(this.mAdditionalNumbers, adn.mAdditionalNumbers);
    }
    ...
    public byte[] buildAdnString(int recordSize) {
        ...
        if (!TextUtils.isEmpty(this.mAlphaTag)) {
            byte[] byteTag = IccUtils.stringToAdnStringField(this.mAlphaTag);
