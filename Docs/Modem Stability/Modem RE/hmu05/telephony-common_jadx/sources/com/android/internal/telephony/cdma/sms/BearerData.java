...
public final class BearerData {
    ...
    public static GsmAlphabet.TextEncodingDetails calcTextEncodingDetails(CharSequence msg, boolean force7BitEncoding) {
        ...
        if (ted2.msgCount == 1 && ted2.codeUnitSize == 1) {
            ...
            if (octets > 140) {
                ted2.msgCount = (octets + UserData.IS91_MSG_TYPE_SHORT_MESSAGE) / 134;
    ...
    private static void decodeUserDataPayload(UserData userData, boolean hasUserDataHeader) throws CodingException {
        ...
        switch (userData.msgEncoding) {
            case 0:
                boolean decodingtypeUTF8 = Resources.getSystem().getBoolean(R.bool.config_avoidGfxAccel);
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: com.android.internal.util.BitwiseInputStream$AccessException */
    private static void decodeIs91(BearerData bData) throws BitwiseInputStream.AccessException, CodingException {
        switch (bData.userData.msgType) {
            case UserData.IS91_MSG_TYPE_VOICEMAIL_STATUS /* 130 */:
                decodeIs91VoicemailStatus(bData);
                return;
            case UserData.IS91_MSG_TYPE_SHORT_MESSAGE_FULL /* 131 */:
            case UserData.IS91_MSG_TYPE_SHORT_MESSAGE /* 133 */:
                decodeIs91ShortMessage(bData);
                return;
            case UserData.IS91_MSG_TYPE_CLI /* 132 */:
                decodeIs91Cli(bData);
                return;
            default:
